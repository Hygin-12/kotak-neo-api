...
# Get Scrip Master CSV file cash segment
#    elif user_input.upper() == 'SMNS':
#        cashUrl = client.scrip_master('nse_cm')
#        Url = "https://lapi.kotaksecurities.com/wso2-scripmaster/v1/prod/2023-02-23/transformed/nse_cm.csv"
#        cashdf = pd.read_csv(Url)
#        cashdf        
#        client.scrip_master()
#        break
...
#        symbols = {'SBIN','NTPC','BSEL'}
#        client.search_scrip(exchange_segment="nse_cm", symbol=symbols, expiry="", option_type="",
#                    strike_price="")
#        break
...
#**********************************************************************************************************************
# open the file with datetime in the write mode
        #f = open("HistoryIntra"+d1+".csv", 'w')

# create the csv writer
        #writer = csv.writer(f)

#**************************************************************************************
        #st = Item[("103061","30108","12531","12024","12194","01029","01027")]
        #instrument_tokens = [{"instrument_token": "103061", "exchange_segment": "nse_cm" },{"instrument_token": "30108", "exchange_segment": "nse_cm"},
        #                     {"instrument_token": "12531", "exchange_segment": "nse_cm"},{"instrument_token": "12024", "exchange_segment": "nse_cm"},
        ...
        response = float(client.quotes(instrument_tokens=instrument_tokens, quote_type="ltp", isIndex=False)['mesage':][0]['ltp'])
        print(response)
        print(ltp)
        #if 'ltp' in response:
        ...
        #quote = float(client.quotes(instrument_tokens = instrument_tokens, quote_type="ltp", isIndex=False)['ltp'])
        #print(ltp)
